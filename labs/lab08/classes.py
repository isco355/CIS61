...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        temp_defense=other_card.defense
        other_card.attack=temp_defense
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for car in player_cards:
            car.attack +=opponent_attack
            car.defense +=opponent_defense
        
        opponent_cards = opponent.deck.cards
        new_opponent_cards  = [ card for card in opponent_cards if card.attack != opponent_attack and card.defense != opponent_defense]
